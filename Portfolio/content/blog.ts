...
const blogContent: Record<Locale, BlogContent> = {
  ...
  ar: {
    badge: "دفتر التعلم",
    heading: "أبني علنًا، فكرة بعد أخرى",
    description:
      "ملاحظات قصيرة حول ما أدرسه الآن. المقالات الكاملة ستُنشر هنا فور جاهزيتها.",
    ...
    prepTitle: "ملاحظات مركزة قبل المقالات الطويلة",
    prepBody:
      "لا توجد تدوينات منشورة بعد؛ أفضّل الإتقان قبل الكتابة. ترقبوا مقالات مفصلة عن الذكاء الاصطناعي التطبيقي و مشكلات الإرضاء المقيدة وأدوات المطورين قريبًا.",
  },
}
