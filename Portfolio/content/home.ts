...
const heroContent: Record<Locale, HeroContent> = {
  ...
  ar: {
    ...
    name: "",
    taglineLead: "أبني وأساعدك على الإطلاق",
    typingLines: ["أنظمة ذكية.", "كودًا نظيفًا.", "أثرًا حقيقيًا."],
    description:
      "مطوّر متكامل وطالب في الذكاء الاصطناعي وعلوم البيانات يبني ويطلق الأفكار التعليمية والخدمات المدنية والمنتجات كتجارب رقمية ذات أثر ملموس.",
    primaryCta: "استكشف أعمالي",
    stats: [
      { label: "المشاريع", value: "10+", detail: "منتجات في مجالي الويب والذكاء الاصطناعي" },
      { label: "الدراسات", value: "ذكاء اصطناعي وبيانات", detail: "ESTIN، 2024 →" },
